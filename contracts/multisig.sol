...
struct Transaction {
    address spender;
    uint amount;
    uint numberOfApproval; // Number of admins that has approved this transaction
    bool isActive; // is the transaction approved or not
}
...
contract MultiSig {
    ...
    function createTransaction(
        ...
        _transaction.isActive = true; // has not been approved for withdrawal
